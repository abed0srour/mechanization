...
export const ar = {
  ...
  citizenField: {
    ...
    totalRegisteredMembers: 'عدد أفراد الأسرة الإجمالي (شاملاً الأبناء المتزوجين)',
    actualHouseholdMembers: 'عدد أفراد الأسرة الفعليين (باستثناء الأبناء المتزوجين المستقلين)',
...
export const en = {
  ...
  citizenField: {
    ...
    actualHouseholdMembers: 'Actual Household Members',
