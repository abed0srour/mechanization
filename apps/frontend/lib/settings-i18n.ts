...
const AR: SettingsCopy = {
  ...
  backup: {
    ...
    tables: {
      ...
      audit: 'سجل النشاطات',
      settings: 'الإعدادات',
      user: 'المستخدمون والمواطنون',
      otpChallenge: 'رموز التحقق (OTP)',
      parcel: 'السجل العقاري (العقارات)',
      zone: 'القطاعات والمناطق',
      auditLogEntry: 'سجل التدقيق والنشاطات',
      systemSettings: 'إعدادات النظام والبلدية',
      registration: 'طلبات التسجيل',
      propertyEntry: 'بطاقات العقارات والوحدات',
      buildingUnit: 'الوحدات السكنية والتجارية',
      document: 'المستندات والوثائق',
      feeNotice: 'إشعارات وجداول الرسوم',
      citizenPayment: 'حركات وإيصالات الدفع',
    },
  },
  cadastre: {
    title: 'السجل العقاري',
...
const EN: SettingsCopy = {
  ...
  backup: {
    ...
    tables: {
      ...
      document: 'Documents',
      feeNotice: 'Fee Notices',
      citizenPayment: 'Citizen Payments',
    },
  },
  cadastre: {
    title: 'Cadastre',
